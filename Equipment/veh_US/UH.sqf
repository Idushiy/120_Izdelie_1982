...
_veh addItemCargoGlobal ["rhsusf_mag_10Rnd_STD_50BMG_M33",5];
_veh addItemCargoGlobal ["ACE_30Rnd_556x45_Stanag_M995_AP_mag",20];
_veh addItemCargoGlobal ["ACE_30Rnd_556x45_Stanag_Tracer_Dim",10];
...
_veh addItemCargoGlobal ["ACE_M84",12];
_veh addItemCargoGlobal ["rhs_mag_m67",7];

_veh addItemCargoGlobal ["UGL_FlareCIR_F",8];
